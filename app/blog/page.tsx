...
const BlogPage = () => {
  ...
  React.useEffect(() => {
    const channel = new BroadcastChannel('blog-control');
    ...
    <div className="min-h-screen bg-transparent relative overflow-hidden pb-24">
      ...
      {!isActive ? (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 min-h-[60vh] flex flex-col items-center justify-center text-center">
            ...
            >
               <Pause className="w-8 h-8 text-white/20 animate-pulse" />
            </motion.div>
            <h2 className="text-4xl font-black tracking-tight mb-4 uppercase italic">Blog Sync: Standby</h2>
